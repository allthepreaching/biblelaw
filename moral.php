...
<div class="content">
        ...
        <li>
          ...
          <ul class="sub">
            <li>
              ...
              <span class="modal-verse" id="1 Thessalonians 3:2-3">3:2-3</span> ,
              <span class="modal-verse" id="1 Timothy 3:2">1 Timothy 3:2</span> ,
      ...
      <ul class="styled">
        <li>
          ...
          <ul class="sub">
            <li>
              <span class="modal-verse" id="Psalm 30:4">Psalm 30:4</span> ,
              <span class="modal-verse" id="Psalm 103:1-2">Psalm 103:1-2</span> ,
              <span class="modal-verse" id="Psalm 104:1">Psalm 104:1</span> ,
              <span class="modal-verse" id="Psalm 117:1">Psalm 117:1</span> ,
              <span class="modal-verse" id="Psalm 134:1-2">Psalm 134:1-2</span> ,
              <span class="modal-verse" id="Psalm 135:1-2">Psalm 135:1-2</span> ,
              <span class="modal-verse" id="Psalm 135:19-20">Psalm 135:19-20</span> ,
              <span class="modal-verse" id="Psalm 145:21">Psalm 145:21</span> ,
              <span class="modal-verse" id="Psalm 146:1-2">Psalm 146:1-2</span> ,
              <span class="modal-verse" id="Psalm 148:11-13">Psalm 148:11-13</span> ,
              <span class="modal-verse" id="Psalm 150:6">Psalm 150:6</span>
            </li>
            <li>
        ...
        <li>
          ...
          <ul class="sub">
            <li>
              ...
              <span class="modal-verse" id="Psalm 135:20-21">135:20-21</span> ,
              <span class="modal-verse" id="Psalm 135:1-3">135:1-3</span> ,
              <span class="modal-verse" id="Psalm 135:26">135:26</span> ,
    ...
    <li>
      ...
      <ul class="styled">
        <li>
          ...
          <span class="modal-verse" id="Proverbs 22:28">22:28</span> ,
  ...
  <ol>
    ...
    <li>
      ...
      <ul class="styled">
        <li>
          ...
          <ul class="sub">
            <li>
              <span class="modal-verse" id="Exodus 21:1">Exodus 21:1</span> ,
              <span class="modal-verse" id="Leviticus 19:17">Leviticus 19:17</span> ,
              ...
              <span class="modal-verse" id="Psalm 96:10">96:10</span> ,
    ...
    <li>
      ...
      <ul class="styled">
        ...
        <li>
          Avoid profane (disrespectful, contemptuous) speech, railing
          <ul class="sub">
            <li>
              <span class="modal-verse" id="1 Corinthians 6:10">1 Corinthians 6:10</span> ,
              <span class="modal-verse" id="Ephesians 4:29">Ephesians 4:29</span> ,
        ...
        <li>
          Don’t profane your brother’s name
          <ul class="sub">
            <li>
        ...
        <li>
          ...
          <ul class="sub">
            <li>
              ...
              <span class="modal-verse" id="Psalm 119:29">52:3</span> ,
              ...
              <span class="modal-verse" id="Ephesians 6:15">6:15</span> ,
    ...
    <li>
      ...
      <ul class="styled">
        <li>
          ...
          <span class="modal-verse" id="1 Chronicles 22:20">1 Chronicles 22:20</span> ,
    ...
    <li>
      ...
      <ul class="styled">
        <li>
          ...
          <span class="modal-verse" id="Psalms 4:4">Psalms 4:4</span> ,
        ...
        <li>
          How to: Pick Bible verses in the morning to memorize and repeatedly think on for the day, read the Bible, listen to the Bible, listen to sermons, etc.
        </li>
      </ul>
    </li>
    <li>
  ...
  <ol>
    ...
    <li>
      <span class="main-li">Don’t deny Jesus; Don’t be ashamed of Jesus</span>
      <ul class="styled">
        <li>
          <span class="modal-verse" id="2 Timothy 1:8">2 Timothy 1:8</span> ,
  ...
  <ol>
    ...
    <li>
      <span class="main-li">Work Ethics</span>
      <ul class="styled">
        <li>
        ...
        <li>
          ...
          <ul class="sub">
            <li>
              ...
              <span class="modal-verse" id="Colossians 22-23">22-23</span>
            </li>
          </ul>
        </li>
        <li>
    ...
    <li>
      ...
      <ul class="styled">
        <li>
          Masters don’t oppress your servants (treat them fairly: justice and equity)
          <ul class="sub">
            <li>
        ...
        <li>
          Discipline your servants (not delicately)
          <ul class="sub">
            <li>
              <span class="modal-verse" id="Proverbs 29:19">Proverbs 29:19</span> ,
              <span class="modal-verse" id="Proverbs 29:21">29:21</span>
            </li>
          </ul>
        </li>
        <li>
          Servants please their masters well in all things (fulfill their desires: more than that which is asked)
          <ul class="sub">
            <li>
              <span class="modal-verse" id="Titus 2:9">Titus 2:9</span>
            </li>
  ...
  <ol>
    ...
    <li>
      ...
      <ul class="styled">
        <li>
          ...
          <span class="modal-verse" id="Revelation 3:5">3:5</span>
        </li>
      </ul>
    </li>
    <li>
    ...
    <li>
      <span class="main-li">Be filled with the Spirit; Walk in the Spirit; Quench not (don’t put out) the Spirit</span>
      <ul class="styled">
        <li>
