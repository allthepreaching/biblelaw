...
<?php include_once 'includes/fetch.inc.php'; ?>
...
<head>
    ...
    <meta property="og:image" content="http://www.biblelaw.allthepreaching.com/images/BL-ATP_OG_Image.png" />
    ...
    <link href="https://fonts.googleapis.com/css2?family=Calligraffitti&family=Cantarell:ital@1&display=swap" rel="stylesheet" />
    ...
    <header>
        <div class="header-container">
            <div class="header-titles">
                <h1 class="site-title">BIBLE LAWS</h1>
                ...
                <h2 class="site-subtitle">Reference Site</h2>
            </div>
        </div>
    </header>
        ...
        <ul class="navbar-nav">
            <li class="logo">
                <a href="index.php" class="logo-text-link">
                    <span class="link-text logo-text">Bible Laws</span>
                </a>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
