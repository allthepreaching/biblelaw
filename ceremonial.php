...
<div class="content">
  ...
  <ol>
    <li>
      ...
      <ul class="styled">
        <li>
          <span class="modal-verse" id="verseeeee">verseeeee</span> ,
        </li>
      </ul>
    </li>
    <li>
    ...
    <li>
      <span class="main-li">Don't eat: flesh that is torn of beasts</span>
      <ul class="styled">
        <li>
    ...
    <li>
      <span class="main-li">Don’t eat or drink blood</span>
      <ul class="styled">
        <li>
    ...
    <li>
      <span class="main-li">Pour out the blood on the ground (of animals you eat)</span>
      <ul class="styled">
        <li>
    ...
    <li>
      ...
      <ul class="styled">
        <li>
          <span class="modal-verse" id="Matthew 5:10-11">Matthew 5:10-11</span> ,
          <span class="modal-verse" id="Matthew 5:16-18">5:16-18</span> ,
