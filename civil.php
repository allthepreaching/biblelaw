...
<div class="content">
  ...
  <ol>
    <li>
      ...
      <ul class="styled">
        <li>
          Judges and officers shalt thou make thee in all thy gates, which the Lord thy God giveth thee, throughout thy tribes (God set up 70 elders and officers under Moses to bear the burden of the people)- to judge the people at all times
          <ul class="sub">
            <li>
    ...
    <li>
      ...
      <ul class="styled">
        ...
        <li>
          He shall not multiply horses to himself; neither shall he greatly multiply to himself silver and gold (covetousness/personal enrichment)
          <ul class="sub">
            <li>
              <span class="modal-verse" id="Deuteronomy 17:16-17">Deuteronomy 17:16-17</span> ,
  ...
  <ol>
    ...
    <li>
      <span class="main-li">Servant girl you marry (concubine-secondary def.)</span>
      <ul class="styled">
        <li>
        ...
        <li>
          Can’t sell her after you marry her
          <ul class="sub">
            <li>
        ...
        <li>
          ...
          <ul class="sub">
            <li>
              ...
              <span class="modal-verse" id="Deuteronomy 9:3-6">Deuteronomy 9:3-6</span> (answers why),
              <span class="modal-verse" id="Deuteronomy 7:17-19">Deuteronomy 7:17-19</span> ,
              <span class="modal-verse" id="Deuteronomy 7:21">Deuteronomy 7:21</span>
            </li>
          </ul>
        </li>
        <li>
